...
import PaymentDiscountSettings from './components/PaymentDiscountSettings'; // ★ 修正：加上 components/ 資料夾路徑
...
const SellerBookingDashboard: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'finance', label: '金流與折抵', icon: 'fa-money-bill-wave' }, // ★ 新增：金流與折抵專屬頁籤
  ...
  return (
    ...
    <div className="w-full bg-white rounded-2xl shadow-sm p-4 md:p-6 max-w-full overflow-hidden animate-fade-in">
      ...
      {/* 子導覽列 (Sub-navigation) - 支援手機與電腦自適應換行，取消左右滑動拉桿 */}
      ...
      <div className="min-h-[400px] w-full">
        ...
        {activeTab === 'finance' && <PaymentDiscountSettings shopId={shopId} />} {/* ★ 新增：渲染金流元件 */}
